...
|---|---|---|---|---|
| 1 | Stabilise | ~5 days | `specs/phase-1-stabilise.md` *(write at start)* | not started |
...
| **Inbox-watch agent** | Per `06a-` — Gmail-drafts pattern, Phase 1 (drafts only, 100% review). Classify + enrich + draft pipeline running every 5 min via Netlify scheduled function |
