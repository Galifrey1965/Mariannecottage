...
- **Agent operational mechanics — parked for Mark-input round (2026-05-02).** Two rows of Table A locked at high-level shape but with implementation details deferred until they can be discussed directly with Mark closer to Phase 4 build:
  ...
  None of these block Phase 1–3. Both will get a dedicated agent-mechanics discussion thread closer to Phase 4.
