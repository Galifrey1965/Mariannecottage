...
| Item | Annual |
|---|---|
| Netlify Personal plan (already in place — bundles hosting + AI Gateway + builds + functions) | **$108 / ~£86** |
| Domain registration | **~£10** |
| Stripe per-transaction fees (~€2/booking × 100 bookings/yr) | **~€200 / ~£170** |
| LLM token usage (full agent network) | **~£18** |
...
**Net financial story:** the cottage gets meaningfully better operational tooling for ~£284/year and a direct path to clawing back ~€1,000+/year of Booking.com commission — for ~22 days of build.
