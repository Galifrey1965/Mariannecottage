...
Implementation history of the Marianne Cottage site, kept for context. Current state lives in [`../README.md`](../README.md) and the per-feature docs.

**Last updated:** 2026-03-23 — Phase 5 complete; email + Stripe parked.
...
- Contact page: small embedded map (zoom 13) centred on cottage
...
Detailed feature notes: [`../features/booking-system.md`](../features/booking-system.md).
...
**Theme colours (mapped from existing palette):**
...
- Home, Rooms, Gallery, Contact, Explore, Legal
...
- **JSON-LD schema:** BedAndBreakfast on all pages, rating 9.6 (from guest testimonials)
- **hreflang:** all pages include alternates for EN/FR/DE + x-default
