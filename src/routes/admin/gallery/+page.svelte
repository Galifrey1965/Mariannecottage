			...
			<div class="pending">
				...
				<div class="pending-form">
					...
					<div class="pending-actions">
						<button type="button" class="btn-link" onclick={resetPending} disabled={uploading}>Cancel</button>
	...
	<div class="modal-backdrop" onclick={closeEdit} role="presentation">
		<div class="modal" onclick={(e) => e.stopPropagation()} role="dialog" aria-modal="true">
			...
			<div class="modal-actions">
				...
				<button type="button" class="btn-link danger" onclick={() => deleteImage(editing!)}>Delete</button>
				<div class="spacer"></div>
				<button type="button" class="btn-link" onclick={closeEdit}>Cancel</button>
...
<style>
	...
	.link-btn { background: none; border: none; padding: 0; color: var(--color-sage); cursor: pointer; font-size: 0.8125rem; }
